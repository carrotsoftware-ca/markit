  ...
  return (
    <View style={s.container}>
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.content}>
        ...
        <Text style={s.body}>
          {COMPANY} ("we", "our", or "us") operates the {APP_NAME} mobile application and website
        ...
        <Text style={s.bullet}>
          • <Text style={{ fontWeight: "600" }}>Profile information</Text> — company name, phone
          number, and other details you provide.
        </Text>
        <Text style={s.bullet}>
          • <Text style={{ fontWeight: "600" }}>Project data</Text> — photos, videos, measurements,
          notes, and documents you upload.
        </Text>
        <Text style={s.bullet}>
          • <Text style={{ fontWeight: "600" }}>Usage data</Text> — device type, operating system,
          app interactions, and crash reports.
        </Text>
        <Text style={s.bullet}>
          • <Text style={{ fontWeight: "600" }}>Communications</Text> — messages sent through the
          Service, including portal links sent to clients.
        </Text>
        ...
        <Text style={s.bullet}>
          • Send project portal links and transactional emails to your clients
        </Text>
        ...
        <Text style={s.body}>
          ...
          service providers who assist us in operating the Service (such as cloud hosting,
          authentication, and email delivery), subject to confidentiality agreements. We may also
          disclose information if required by law.
        </Text>

        <Text style={s.sectionTitle}>4. Data Storage and Security</Text>
        <Text style={s.body}>
          Your data is stored on Google Firebase infrastructure. We implement industry-standard
          security measures including encryption in transit (TLS) and at rest. However, no method of
        ...
        <Text style={s.body}>
          To exercise these rights, contact us at <Text style={s.link}>{CONTACT_EMAIL}</Text>.
        </Text>
        ...
        <Text style={s.body}>
          Our Service uses the following third-party services which have their own privacy policies:
          Google Firebase (authentication, database, storage, analytics), Google Sign-In, Apple
          Sign-In, and SendGrid (email delivery).
        </Text>
