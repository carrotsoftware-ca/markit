    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        >
          ...
          <Text style={[styles.googleBtnText, { fontFamily: t.fontFamily.semiBold }]}>
        ...
        >
          ...
          <Text style={[styles.appleBtnText, { fontFamily: t.fontFamily.semiBold }]}>
            Continue with Apple
          </Text>
        </Pressable>
        ...
        <View style={styles.dividerRow}>
          ...
          <Text
            style={[styles.dividerText, { color: c.gray[500], fontFamily: t.fontFamily.regular }]}
          >
            OR CONTINUE WITH
          </Text>
          <View style={[styles.dividerLine, { backgroundColor: c.gray[700] }]} />
        ...
        <View style={styles.passwordLabelRow}>
          ...
          <Pressable onPress={handleForgotPassword}>
            <Text
              style={[styles.forgot, { color: c.safetyOrange, fontFamily: t.fontFamily.regular }]}
            >
              Forgot?
            </Text>
          </Pressable>
        ...
        >
          {loading ? (
            ...
            <Text style={[styles.signInBtnText, { fontFamily: t.fontFamily.bold }]}>
              Sign In with Email →
            </Text>
          )}
        </Pressable>
        ...
        <View style={styles.registerRow}>
          <Text
            style={[styles.registerText, { color: c.gray[400], fontFamily: t.fontFamily.regular }]}
          >
